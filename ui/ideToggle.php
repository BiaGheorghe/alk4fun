...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;400;500&family=Tiro+Tamil&display=swap" rel="stylesheet">
...
<ul class="rc-menu-file-input off" id="rc-menu-file-input-id">
    <li class="rc-menu-items" id="use-file-input">Use as Input File</li>
    <li class="rc-menu-items" id="rename-file-input">Rename File</li>
    <li class="rc-menu-items" id="delete-file-input">Delete File</li>
</ul>
...
<div class="container main">
    <section>
        <input id="s1" type="checkbox" name="t1" unchecked/>
        <label  for="s1">Parameters</label>
        <div class="parameters" id="parameters" onchange= "changeParameters()">
            <div class="input">
                <form class="input-file" action="" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="upload off" id="upload">
                        ...
                        <span class="server-file-help">If you want to use an input file from your project, right-click on the file and select "Use as Input File"</span>
                    </div>
                </form>
...
<pre class="output"><br> Output:<br></pre>
